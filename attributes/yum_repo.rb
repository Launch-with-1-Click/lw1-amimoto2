...
if node[:yum][:repo][:amimoto_repo]
  ...
  default[:yum][:repo][:remi][:php55][:baseurl] = 'https://repos.amimoto-ami.com/enterprise/6/remi-php55/x86_64/'
  default[:yum][:repo][:remi][:php56][:baseurl] = 'https://repos.amimoto-ami.com/enterprise/6/remi-php56/x86_64/'
  ...
  default[:yum][:repo][:nginx][:baseurl] = 'https://repos.amimoto-ami.com/enterprise/6/amimoto-nginx-mainline/x86_64/'
